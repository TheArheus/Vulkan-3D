...
set CommonCompFlags=-nologo -fp:fast -MT -EHa- -Od -Oi -WX- -W4 -GR- -Gm- -GS -FC -Z7 -D_MBCS -DVK_DEBUG=1 -wd4100 -wd4189 -wd4201 -wd4530 -D_CRT_SECURE_NO_WARNINGS -DENABLE_SPIRV_CODEGEN=ON /I%VulkanInc%
...
C:\DirectXShaderCompiler.bin\Debug\bin\dxc.exe -O2 -spirv -T cs_6_6 -E main ..\shaders\cmd.comp.hlsl /Zi -Fo ..\shaders\cmd.comp.spv -enable-16bit-types -fspv-target-env=vulkan1.2 -fspv-extension=SPV_KHR_16bit_storage
