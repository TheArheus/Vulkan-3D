...
C:\DirectXShaderCompiler.bin\Debug\bin\dxc.exe -spirv -T ms_6_6 -E main ..\shaders\object.mesh.hlsl -Fo ..\shaders\object.mesh.spv -enable-16bit-types -fspv-target-env=vulkan1.2 -fspv-extension=SPV_NV_mesh_shader -fspv-extension=SPV_KHR_16bit_storage -D_DEBUG=1
